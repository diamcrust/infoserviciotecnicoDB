    ...
    <tbody>
        <?php
            ...
            while($row = $result->fetch_assoc()) {
                echo "<form action='../Funciones/EscribeCliente.php' method = 'POST'>";
                echo "<tr>";
                echo "<input type='hidden' name='id' value='".$row["cve_cliente"]."'>";
                echo "<td><input type = 'number' class='form-control' name='cve_cliente' value='".$row["cve_cliente"]."'></td>";
                ...
                echo "<td><input class='form-control' name='tarifa' value='".$row["tarifa"]."'></td>";
